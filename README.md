[![GoDoc](https://godoc.org/github.com/alimoeeny/podcast?status.svg)](https://godoc.org/github.com/alimoeeny/podcast)
[![Build Status](https://travis-ci.org/alimoeeny/podcast.svg?branch=master)](https://travis-ci.org/alimoeeny/podcast)
[![Coverage Status](https://coveralls.io/repos/github/alimoeeny/podcast/badge.svg?branch=master)](https://coveralls.io/github/alimoeeny/podcast?branch=master)
[![Go Report Card](https://goreportcard.com/badge/github.com/alimoeeny/podcast)](https://goreportcard.com/report/github.com/alimoeeny/podcast)
[![MIT License](https://img.shields.io/npm/l/mediaelement.svg)](https://alimoeeny.mit-license.org/)

# podcast
Package podcast generates a fully compliant iTunes and RSS 2.0 podcast feed
for GoLang using a simple API.

Full documentation with detailed examples located at <a href="https://godoc.org/github.com/alimoeeny/podcast">https://godoc.org/github.com/alimoeeny/podcast</a>

### Usage
To use, `go get` and `import` the package like your typical GoLang library.

	$ go get -u github.com/alimoeeny/podcast
	
	import "github.com/alimoeeny/podcast"
...
Full detailed Examples of the API are at <a href="https://godoc.org/github.com/alimoeeny/podcast">https://godoc.org/github.com/alimoeeny/podcast</a>.
...
- - -
Generated by [godoc2ghmd](https://github.com/alimoeeny/godoc2ghmd)
